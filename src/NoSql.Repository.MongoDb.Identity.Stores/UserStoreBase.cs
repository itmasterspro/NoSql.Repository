...
namespace ItMastersPro.NoSql.Repository.MongoDb.Identity
{
        ...
        where TUserToken : IdentityUserToken, new()
    {
        ...
        protected abstract Task<TUser> FindUserAsync(ObjectId userId, CancellationToken cancellationToken);
        ...
        protected abstract Task<TUserLogin> FindUserLoginAsync(ObjectId userId, string loginProvider, string providerKey, CancellationToken cancellationToken);
        ...
        where TRoleClaim : IdentityRoleClaim, new()
    {
        ...
        protected abstract Task<TUserRole> FindUserRoleAsync(ObjectId userId, ObjectId roleId, CancellationToken cancellationToken);
    }
}
