...
namespace ItMastersPro.NoSql.Repository.MongoDb.Identity
{
    ...
    public class UserOnlyStore<TUser> : UserOnlyStore<TUser, IMongoDbContext> where TUser : Identity.IdentityUser, new()
    {
        /// <summary>
    ...
    public class UserOnlyStore<TUser, TContext> : UserOnlyStore<TUser, TContext, Identity.IdentityUserClaim, Identity.IdentityUserLogin, Identity.IdentityUserToken>
        ...
        where TUserToken : Identity.IdentityUserToken, new()
    {
        ...
        /// DbSet of users.
        /// </summary>
        protected IMongoDbRepository<TUser> UsersSet { get { return Context.Set<TUser>().Result; } }

        /// <summary>
        /// DbSet of user claims.
        /// </summary>
        protected IMongoDbRepository<TUserClaim> UserClaims { get { return Context.Set<TUserClaim>().Result; } }

        /// <summary>
        /// DbSet of user logins.
        /// </summary>
        protected IMongoDbRepository<TUserLogin> UserLogins { get { return Context.Set<TUserLogin>().Result; } }

        /// <summary>
        /// DbSet of user tokens.
        /// </summary>
        protected IMongoDbRepository<TUserToken> UserTokens { get { return Context.Set<TUserToken>().Result; } }
        ...
        public override Task<TUser> FindByNameAsync(string normalizedUserName, CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
            return Task.Run(()=>Users.FirstOrDefault(u => u.NormalizedUserName == normalizedUserName), cancellationToken);
        }
        ...
        {
            return UsersSet.FindAsync(u => u.Id.Equals(userId), cancellationToken);
        }
        ...
        public async override Task<IList<Claim>> GetClaimsAsync(TUser user, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var result = UserClaims.Collection.AsQueryable().Where(uc => uc.UserId.Equals(user.Id)).ToList();
